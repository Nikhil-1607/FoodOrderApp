...
import com.example.chaton.Adapters.TopStatusAdapter;
import com.example.chaton.Adapters.UsersAdapter;
import com.example.chaton.Models.Status;
import com.example.chaton.Models.User;
import com.example.chaton.Models.UserStatus;
        ...
        mFirebaseRemoteConfig.fetchAndActivate().addOnSuccessListener(new OnSuccessListener<Boolean>() {
            ...
            public void onSuccess(Boolean aBoolean) {
                ...
                if(isToolBarImageEnabled) {
                    ...
                    // Provide a default color in case the value is not set in the Firebase Remote Config
                    if (!TextUtils.isEmpty(toolbarColor)) {
                        ...
                        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#28852C")));
                    }
